...
// Flash Sale
const FLASH_KEY='cf2_scanned_shops';let flashItems=[],flashAbort=null;
...
// Batch Flash Sale có lọc giá gốc
...
// Voucher (giữ nguyên batch, không thay đổi)
const VOUCH_KEY='vcat_scanned_shops';let vouchVouchers=[],vouchAbort=null;
...
const vToK=v=>Math.round(v/100000000);const vFormatK=v=>{const num=v/100000;if(num>=1000000)return (num/1000000).toFixed(1)+'tr';if(num>=1000)return (num/1000).toFixed(0)+'k';return num.toLocaleString('vi-VN');};
